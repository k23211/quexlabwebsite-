    ...
    <div style={{ background: PAPER, color: INK }}>
      ...
      <main>
        <section className="mx-auto grid max-w-7xl gap-10 px-5 pb-16 pt-14 sm:px-10 sm:pb-24 sm:pt-20 lg:grid-cols-[0.85fr_1.15fr] lg:items-center lg:gap-20">
          ...
          <div className="relative aspect-[4/3] overflow-hidden" style={{ background: "#0F0B1E" }}><Image src="/adinkra-match-1.png" alt="Adinkra Match game screens" fill priority sizes="(min-width: 1024px) 55vw, 100vw" className="object-contain p-5 sm:p-10" /></div>
        </section>
